...
const Form = () => {
    ...
    const handleSubmit = async () => {
        ...
        console.log(generate_string_aléatoire(7))
        ...
        try {
            ...
            if(response?.data){
                setQrData(`http://127.0.0.1:8000/${response?.data?.id}`);
                // setQrData(`https://card.lacarteboss.com/${response?.data?.id}`);
                ...
                await api.put(BASE_API_URL+"/api/cards/"+response?.data?.id+"/", qrCodeData)
