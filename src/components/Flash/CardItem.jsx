  ...
  return (
        <div className="p-3">
            ...
            <div className='grid grid-cols-1 gap-3 my-5 ml-3' style={{fontSize: "1rem"}}>
                ...
                <Link to={`/carte/${item?.card_id}`} target="_blank" className="flex justify-center items-center gap-2 bg-[#26265eff] text-white border rounded-lg py-2 px-4"><Share size={15} /> Partager</Link>
            </div>
        </div>
  )
}
