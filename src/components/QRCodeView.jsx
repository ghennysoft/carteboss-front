...
const QRCodeView = ({item, open}) => {
  return (
    <div className='flex justify-center items-center fixed w-full h-full top-0 left-0 bg-gray-400 p-5'>
      <div className="flexflex-col justify-center items-center lg:max-w-1/3 bg-white rounded-lg py-5 px-10">
        ...
        <div className="flex flex-col border border-[#26265eff] border-3 rounded-lg overflow-hidden">
            {/* <img src={"/no-img.jpg"} width={200} height={200} alt="qrcode" /> */}
            <img src={item?.qrCode?.url} alt="qrcode" />
